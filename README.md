...
git clone [https://github.com/imvietcuongfrvietnam/KEARL4EEDFJSP.git](https://github.com/imvietcuongfrvietnam/KEARL4EEDFJSP.git)
cd KEARL4EEDFJSP

### 2. Install Miniconda
If you haven't installed Conda yet, download and install Miniconda here: 
